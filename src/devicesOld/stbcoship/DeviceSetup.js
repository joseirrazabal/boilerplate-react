...
class STBCoshipDeviceSetup extends AbstractDeviceSetup {
  /* constructor() {
    super();
  } */

  setup () {
    STBCoshipDeviceSetup.getUserInfo();
  }
  ...
  static getUserInfo() {
    ...
    catch (e) { console.error("[STBCoshipDeviceSetup.getUserInfo]", e); }
    if (response) {
...
export default STBCoshipDeviceSetup;
