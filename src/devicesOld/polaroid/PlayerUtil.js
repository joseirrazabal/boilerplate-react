...
class PolaroidPlayerUtil extends PlayerUtil {
    ...
    resolveStreamType(encodes, provider, isLive) {
      let device_config = Device.getDevice().getConfig();
        ...
        let preferedStreamType = playerConstants.DASHWV;
        let preferedStreamType_ma = playerConstants.DASHWV_MA;
...
export default PolaroidPlayerUtil;
