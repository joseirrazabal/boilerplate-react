...
import { SHOW_MODAL, HIDE_MODAL, MODAL_SUCCESS, MODAL_KEYBOARD, MODAL_UPDATE_EMAIL, MODAL_CONFIRMATION } from '../../actions/modal';
...
class ModalWrapper extends PureComponent {
    ...
    render() {
        ...
        if (this.props.children) content.push(<div className="modal-children" key={this.props.children} >{this.props.children}</div>);
        ...
        return (
            <div className="modal-overlay">
                {this.props.scrollable ?
                    <Scrollable className={`modal-container ${this.props.className} scroll`} height='650px' >{content}</Scrollable> :
...
const closeable = (ModalComponent) => {
    return class extends React.Component {
        ...
        render() {
            return <ModalComponent {...this.props} handleClose={this.props.dispatch({ type: MODAL_CONFIRMATION })} handleSecondModal={this.handleSecondModal}/>
        }
    }
}
export const withOnClose = (component) => connect()(closeable(component));
export default withOnClose(ModalWrapper);
