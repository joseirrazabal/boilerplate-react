...
class Ribbon extends Component {
  ...
  render() {
    ...
    const buttonMoreOptions = config_remote_control
      ? spanYellow
      : pressAndHoldOk;
     //console.log('[rent] this.props.items',this.props.items);
    ...
    return (
      ...
      >
        <div className="ribbon-title">{this.props.title}
        {
        window.location.href.includes("/rents") === true ?
        <span><b style={{ color: '#4E565C' }}> ({String(this.props.lengthItems).padStart(this.props.lengthItems === 0 ? 1 : 2, '0')})</b></span>
        : null
        }
        </div>
        <div
        ...
        >
            <div className={`ribbon-items`}>
              ...
              this.ribbonId !== `Hard2` ?
                ...
                <Slider {...settings} slidesToShow={this.ribbonId !== "Destaque" ? this.props.slidesToShow : 5.6 }>
                  ...
                  return (
                    ...
                    <ItemCard
                      ...
                      key={key}
                      data={node_item}
                      endDate={node_item.endDate}
                      startDate={node_item.startDate}
                      price={node_item.price}
                      currency={node_item.currency}
                      group_id={node_item.group_id || node_item.id}
                      cover={
                        this.ribbonId === "destaque" ?
                        node_item.image_highlight: `${window.location.href.includes("/search") === true //este cambio hay que ver por que esta asi!
                        && typeof node_item.id === "string" ?
                        node_item.image_small
                        :
                        node_item.cover}`
                      }
